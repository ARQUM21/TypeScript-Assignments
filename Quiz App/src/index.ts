...
const radioInputContainer = document.querySelector("#radio-input-container") as HTMLDivElement;
...
const selectedAnswers: string[] = Array(quizQuestions.length).fill(""); // Array to store selected answers
